% Effet tunnel: ce code donne un graphique des résultats experimentaux et
% théoriques des coefficents de reflexion et de transmission pour l'effet
% tunnel.
...
a=5;                                  % Nombre d'iterations (on roule 'a' fois l'effet tunnel)
V_tunnel=linspace(10^-18,10^(-14),a);   % 'a' différentes valeurs de potentiel de la barrière
% V_tunnel=0.15*10^(-14);
