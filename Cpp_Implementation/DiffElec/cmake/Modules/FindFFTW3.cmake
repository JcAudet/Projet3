...
find_library(FFTW_OMP_LIBRARY
  ...
  PATHS ${FFTW3_DIR}
  PATH_SUFFIXES lib
  DOC "Directory where the FFTW3-omp library is located"
  NO_DEFAULT_PATH
)
...
MESSAGE(STATUS "Found FFTW omp: ${FFTW_OMP_LIBRARIES}")
ENDIF (NOT FFTW_OMP_FIND_QUIETLY)
ELSE (FFTW_OMP_FOUND)
IF (FFTW_OMP_FIND_REQUIRED)
MESSAGE(FATAL_ERROR "Could not find FFTW omp library")
...
IF (${ON_UNIX})
SET (FFTW_EXECUTABLE_LIBRARIES fftw3f fftw3f_omp)
ENDIF (${ON_UNIX})
